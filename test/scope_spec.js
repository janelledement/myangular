...
describe('Scope', function () {
  ...
  it('can be constructed and used as an opject', function () {
    var scope = new Scope();
    scope.aProperty = 1;
  ...
  describe('digest', function () {
    ...
    it('calls the listerner function on watch on first $digest', function () {
    ...
    it('calls the watch function with scope as its argument', function () {
  ...
  describe('$watchGroup', function () {
    ...
    it('does not call the zero-watch listener when deregistered first', function () {
      ...
      var destroyGroup = scope.$watchGroup([], function(newValue, oldValues, scope) {
        counter++;
      });
